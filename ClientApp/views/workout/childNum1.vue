<template>
	<div>
		<div class="edit-mask" v-if="isEdit">
			<div class="is-edit">
				<div class="header">选择需要在列表中显示的指标<img v-on:click="isEdit = false" style="width: 20px;height: 20px;vertical-align: top;float: right;margin-top: 2px;cursor: pointer;" src="../../assets/imgs/close.png" /></div>
				<div class="body">
		...
		<div class="edit-mask" v-if="isDuibi">
			<div class="is-edit" style="width: 800px;">
				<div class="header" style="text-align: center;">{{listType == 1?'基础体能雷达对比图':'稳定和均衡雷达对比图'}}<img v-on:click="isDuibi = false" style="width: 20px;height: 20px;vertical-align: top;float: right;margin-top: 2px;cursor: pointer;" src="../../assets/imgs/close.png" /></div>
				<div class="body">
			...
			<div class="body-item" style="overflow-x: hidden;">
				<div class="title" style="min-width: 852px;">
					<div style="float: right;">
						<img v-if="listType == 1 || listType == 3" src="../../assets/imgs/vs.png" style="width:  20px;height:  20px;vertical-align:  top;margin: 18px 10px;cursor: pointer;" v-on:click="duibi()" />
						<img v-if="listType == 1 || listType == 3" src="../../assets/imgs/edit.png" style="width:  20px;height:  20px;vertical-align:  top;margin: 18px 10px;cursor: pointer;" v-on:click="isEdit = !isEdit" />
						<img src="../../assets/imgs/wen.png" style="width:  20px;height:  20px;vertical-align:  top;margin: 18px 10px;cursor: pointer;" v-on:click="showPingFen = false" /></div>
					<ul class="title-tab">
						...
						<table style="margin-bottom: 50px;">
							...
							<tbody>
								<tr v-for="(item,index) in staminaList">
									<th style="min-width: 80px;max-width: 80px;width: 80px;left:0px;"><input :disabled="!(listType == 1 || listType == 3)" type="checkbox" name="check" :value="index" v-model="check" /></th>
									...
									<td>{{list[index].TrainSecName}}</span>
									</td>
		...
		<div class="mask" v-if="daochu">
			<div class="daochu-mask">
				<div class="title">
					...
					<span>选择导出项</span>
					<input v-if="listType == 1 && daochuNum == 1" style="margin: 17px 6px 0px 20px;vertical-align:  top;" value="1" type="checkbox" name="alldaochu" v-model="allDaoChu1">
					<input v-if="listType == 1 && daochuNum == 2" style="margin: 17px 6px 0px 20px;vertical-align:  top;" value="1" type="checkbox" name="alldaochunext" v-model="allDaoChuNext1">

					<input v-if="listType == 2 && daochuNum == 1" style="margin: 17px 6px 0px 20px;vertical-align:  top;" value="1" type="checkbox" name="alldaochu" v-model="allDaoChu2">
					<input v-if="listType == 2 && daochuNum == 2" style="margin: 17px 6px 0px 20px;vertical-align:  top;" value="1" type="checkbox" name="alldaochunext" v-model="allDaoChuNext2">

					<input v-if="listType == 3 && daochuNum == 1" style="margin: 17px 6px 0px 20px;vertical-align:  top;" value="1" type="checkbox" name="alldaochu" v-model="allDaoChu3">
					<input v-if="listType == 3 && daochuNum == 2" style="margin: 17px 6px 0px 20px;vertical-align:  top;" value="1" type="checkbox" name="alldaochunext" v-model="allDaoChuNext2">
					<span>全选/全不选</span>
				</div>
				<div v-if="daochuNum == 1" class="daochu-table">
					<div v-if="listType == 1" style="line-height: 40px;float: left;width: 50%;" v-for="item in sportList"><input style="margin-left: 6px;" :value="item.FullName" type="checkbox" name="user" v-model="userXuanZe1" />{{item.FullName}}</div>
					<div v-if="listType == 2" style="line-height: 40px;float: left;width: 50%;" v-for="item in sportList"><input style="margin-left: 6px;" :value="item.FullName" type="checkbox" name="user" v-model="userXuanZe1" />{{item.FullName}}</div>
					<div v-if="listType == 3" style="line-height: 40px;float: left;width: 50%;" v-for="item in sportList"><input style="margin-left: 6px;" :value="item.FullName" type="checkbox" name="user" v-model="userXuanZe1" />{{item.FullName}}</div>
				</div>
